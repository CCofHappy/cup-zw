...
<div class="mattersConcerned">
    <div class="newerGuid">
        ...
        <div class="container">
            ...
            <el-row :gutter="20">
                <el-col :span="4">
                    <leftBar :navNum="'13'" :leftIndex="['1']"></leftBar>
                </el-col>
                <el-col :span="20">
                    <div class="help_right">
                        <h3>中威网用户注册协议</h3>
                        <div class="pad0_30">
                            <p>本协议由您与惠州市中威酒业有限公司共同缔结，本协议具有合同效力。
                            <br/>本协议中协议双方合称协议方，惠州市中威酒业有限公司在协议中亦称为"中威网"。(域名为www.cwhisky.com）</p>
                            <div class="title">一、 协议内容及签署</div>
                            ...
                            <div class="title">三、会员帐号、密码及安全</div>
                            ...
                            <div class="title">四、注册会员的义务及承诺</div>
                            ...
                            <div class="title">八、法律适用、管辖与其它</div>
                        ...
                        <div class="hint">提示：本《中威网网用户注册协议》中约定有关争议管辖应提交中威网注册地人民法院。</div>
                    </div>
                </el-col>
            </el-row>
        </div>
